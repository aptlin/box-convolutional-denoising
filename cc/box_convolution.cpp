...
void splitParameters(at::Tensor &x_min, at::Tensor &x_max, at::Tensor &y_min,
                     at::Tensor &y_max, at::Tensor &xMinInt,
                     at::Tensor &xMaxInt, at::Tensor &yMinInt,
                     at::Tensor &yMaxInt, at::Tensor &xMinFrac,
                     at::Tensor &xMaxFrac, at::Tensor &yMinFrac,
                     at::Tensor &yMaxFrac) {
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      x_min.scalar_type(), "cpu::splitParameters", ([&] {
        scalar_t minInt, maxInt;

        for (int i = 0; i < x_min.numel(); ++i) {
          minInt = std::ceil(x_min.data_ptr<scalar_t>()[i]);
          xMinFrac.data_ptr<scalar_t>()[i] =
              minInt - x_min.data_ptr<scalar_t>()[i];
          xMinInt.data_ptr<int>()[i] = static_cast<int>(minInt);

          minInt = std::ceil(y_min.data_ptr<scalar_t>()[i]);
          yMinFrac.data_ptr<scalar_t>()[i] =
              minInt - y_min.data_ptr<scalar_t>()[i];
          yMinInt.data_ptr<int>()[i] = static_cast<int>(minInt);

          maxInt = std::floor(x_max.data_ptr<scalar_t>()[i]);
          xMaxFrac.data_ptr<scalar_t>()[i] =
              x_max.data_ptr<scalar_t>()[i] - maxInt;
          xMaxInt.data_ptr<int>()[i] = static_cast<int>(maxInt) + 1;

          maxInt = std::floor(y_max.data_ptr<scalar_t>()[i]);
          yMaxFrac.data_ptr<scalar_t>()[i] =
              y_max.data_ptr<scalar_t>()[i] - maxInt;
...
void splitParametersUpdateGradInput(at::Tensor &x_min, at::Tensor &x_max,
                                    at::Tensor &y_min, at::Tensor &y_max,
                                    at::Tensor &xMinInt, at::Tensor &xMaxInt,
                                    at::Tensor &yMinInt, at::Tensor &yMaxInt,
                                    at::Tensor &xMinFrac, at::Tensor &xMaxFrac,
                                    at::Tensor &yMinFrac,
                                    at::Tensor &yMaxFrac) {
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      x_min.scalar_type(), "cpu::splitParametersUpdateGradInput", ([&] {
        scalar_t minInt, maxInt;

        for (int i = 0; i < x_min.numel(); ++i) {
          minInt = std::ceil(-x_max.data_ptr<scalar_t>()[i]);
          xMinFrac.data_ptr<scalar_t>()[i] =
              minInt + x_max.data_ptr<scalar_t>()[i];
          xMinInt.data_ptr<int>()[i] = static_cast<int>(minInt);

          minInt = std::ceil(-y_max.data_ptr<scalar_t>()[i]);
          yMinFrac.data_ptr<scalar_t>()[i] =
              minInt + y_max.data_ptr<scalar_t>()[i];
          yMinInt.data_ptr<int>()[i] = static_cast<int>(minInt);

          maxInt = std::floor(-x_min.data_ptr<scalar_t>()[i]) + 1;
          xMaxFrac.data_ptr<scalar_t>()[i] =
              -x_min.data_ptr<scalar_t>()[i] + 1 - maxInt;
          xMaxInt.data_ptr<int>()[i] = static_cast<int>(maxInt);

          maxInt = std::floor(-y_min.data_ptr<scalar_t>()[i]) + 1;
          yMaxFrac.data_ptr<scalar_t>()[i] =
              -y_min.data_ptr<scalar_t>()[i] + 1 - maxInt;
...
void splitParametersAccGradParameters(
    ...
    at::Tensor &xMinInt, at::Tensor &xMaxInt, at::Tensor &yMinInt,
    at::Tensor &yMaxInt, at::Tensor &xMinFrac, at::Tensor &xMaxFrac,
    at::Tensor &yMinFrac, at::Tensor &yMaxFrac) {
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      x_min.scalar_type(), "cpu::splitParametersAccGradParams", ([&] {
        scalar_t minInt, maxInt;

        for (int i = 0; i < x_min.numel(); ++i) {
          minInt = std::ceil(x_min.data_ptr<scalar_t>()[i] - 1);
          xMinFrac.data_ptr<scalar_t>()[i] =
              minInt - x_min.data_ptr<scalar_t>()[i] + 1;
          xMinInt.data_ptr<int>()[i] = static_cast<int>(minInt);

          minInt = std::ceil(y_min.data_ptr<scalar_t>()[i] - 1);
          yMinFrac.data_ptr<scalar_t>()[i] =
              minInt - y_min.data_ptr<scalar_t>()[i] + 1;
          yMinInt.data_ptr<int>()[i] = static_cast<int>(minInt);
...
void boxConvUpdateOutput(at::Tensor &xMinInt, at::Tensor &xMaxInt,
                         at::Tensor &yMinInt, at::Tensor &yMaxInt,
                         at::Tensor &xMinFrac, at::Tensor &xMaxFrac,
                         at::Tensor &yMinFrac, at::Tensor &yMaxFrac,
                         at::Tensor &area, at::Tensor &input_integrated,
                         at::Tensor &output) {
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      output.scalar_type(), "cpu::boxConvUpdateOutput", ([&] {
        ...
        for (int batchIdx = 0; batchIdx < input_integrated.size(0);
             ++batchIdx) {
          for (int inPlaneIdx = 0; inPlaneIdx < input_integrated.size(1);
               ++inPlaneIdx) {
            ...
            for (int filterIdx = 0; filterIdx < xMinInt.size(1); ++filterIdx) {
              ...
              for (int x = 0; x < h; ++x) {
                for (int y = 0; y < w; ++y) {
                  ...
                  const scalar_t xMinCurrFrac =
                      xMinFracAcsr[inPlaneIdx][filterIdx];
                  const scalar_t xMaxCurrFrac =
                      xMaxFracAcsr[inPlaneIdx][filterIdx];
                  const scalar_t yMinCurrFrac =
                      yMinFracAcsr[inPlaneIdx][filterIdx];
                  const scalar_t yMaxCurrFrac =
                      yMaxFracAcsr[inPlaneIdx][filterIdx];
                  ...
                  // -- main area
                  outValue = inputIntAcsr[b][r] - inputIntAcsr[t][r] -
                             inputIntAcsr[b][l] + inputIntAcsr[t][l];

                  if (exact) {
                    // -- xMax border
                    outValue += (inputIntAcsr[bAdv][r] - inputIntAcsr[b][r] -
                                 inputIntAcsr[bAdv][l] + inputIntAcsr[b][l]) *
                                xMaxCurrFrac;

                    // -- yMax border
                    outValue += (inputIntAcsr[b][rAdv] - inputIntAcsr[b][r] -
                                 inputIntAcsr[t][rAdv] + inputIntAcsr[t][r]) *
                                yMaxCurrFrac;

                    // -- xMin border
                    outValue += (inputIntAcsr[t][r] - inputIntAcsr[tAdv][r] -
                                 inputIntAcsr[t][l] + inputIntAcsr[tAdv][l]) *
                                xMinCurrFrac;

                    // -- yMin border
                    outValue += (inputIntAcsr[b][l] - inputIntAcsr[b][lAdv] -
                                 inputIntAcsr[t][l] + inputIntAcsr[t][lAdv]) *
                                yMinCurrFrac;

                    // -- corner pixels
                    // Note: before, I used plain `input` to access corner
                    // values with lower memory overhead. Moved to
                    // `input_integrated` to get rid of an extra input to this
                    // function.
                    ...
                    if (not((x + xMaxCurr >= h) | (y + yMaxCurr >= w) |
                      ...
                      outValue +=
                          ...
                          (inputIntAcsr[b + 1][r + 1] - inputIntAcsr[b][r + 1] -
                           inputIntAcsr[b + 1][r] + inputIntAcsr[b][r]);
                    }
                    ...
                    if (not((x + xMinCurr > h) | (y + yMaxCurr >= w) |
                      ...
                      outValue +=
                          ...
                          (inputIntAcsr[t][r + 1] - inputIntAcsr[t - 1][r + 1] -
                           inputIntAcsr[t][r] + inputIntAcsr[t - 1][r]);
                    }
                    ...
                    if (not((x + xMaxCurr >= h) | (y + yMinCurr > w) |
                      ...
                      outValue +=
                          ...
                          (inputIntAcsr[b + 1][l] - inputIntAcsr[b][l] -
                           inputIntAcsr[b + 1][l - 1] + inputIntAcsr[b][l - 1]);
                    }
                    ...
                    if (not((x + xMinCurr > h) | (y + yMinCurr > w) |
                      ...
                      outValue +=
                          ...
                          (inputIntAcsr[t][l] - inputIntAcsr[t - 1][l] -
                           inputIntAcsr[t][l - 1] + inputIntAcsr[t - 1][l - 1]);
                    }
                  }

                  *(outputData++) =
                      outValue * (normalize ? areaAcsr[inPlaneIdx][filterIdx]
...
template void boxConvUpdateOutput<true, true>(at::Tensor &, at::Tensor &,
                                              at::Tensor &, at::Tensor &,
                                              at::Tensor &, at::Tensor &,
                                              at::Tensor &, at::Tensor &,
                                              at::Tensor &, at::Tensor &,
...
template void boxConvUpdateOutput<false, true>(at::Tensor &, at::Tensor &,
                                               at::Tensor &, at::Tensor &,
                                               at::Tensor &, at::Tensor &,
                                               at::Tensor &, at::Tensor &,
                                               at::Tensor &, at::Tensor &,
...
template void boxConvUpdateOutput<true, false>(at::Tensor &, at::Tensor &,
                                               at::Tensor &, at::Tensor &,
                                               at::Tensor &, at::Tensor &,
                                               at::Tensor &, at::Tensor &,
                                               at::Tensor &, at::Tensor &,
...
template void boxConvUpdateOutput<false, false>(at::Tensor &, at::Tensor &,
                                                at::Tensor &, at::Tensor &,
                                                at::Tensor &, at::Tensor &,
                                                at::Tensor &, at::Tensor &,
                                                at::Tensor &, at::Tensor &,
...
// `grad_output_integrated` size: {batchSize, nInputPlanes, numFilters, h+1,
// w+1} `tmpArray` size: {batchSize, nInputPlanes, numFilters, h, w}
template <bool normalize, bool exact>
void boxConvUpdateGradInput(at::Tensor &xMinInt, at::Tensor &xMaxInt,
                            at::Tensor &yMinInt, at::Tensor &yMaxInt,
                            at::Tensor &xMinFrac, at::Tensor &xMaxFrac,
                            at::Tensor &yMinFrac, at::Tensor &yMaxFrac,
                            at::Tensor &area,
                            at::Tensor &grad_output_integrated,
                            at::Tensor &tmpArray) {
  // was `const int`, but had to remove `const` to work around a bug in GCC 5
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      tmpArray.scalar_type(), "cpu::boxConvUpdateGradInput", ([&] {
        auto xMinIntAcsr = xMinInt.accessor<int, 2>();
        auto xMaxIntAcsr = xMaxInt.accessor<int, 2>();
        auto yMinIntAcsr = yMinInt.accessor<int, 2>();
        auto yMaxIntAcsr = yMaxInt.accessor<int, 2>();
        ...
        for (int batchIdx = 0; batchIdx < grad_output_integrated.size(0);
             ++batchIdx) {
          for (int inPlaneIdx = 0; inPlaneIdx < grad_output_integrated.size(1);
               ++inPlaneIdx) {
            for (int filterIdx = 0; filterIdx < xMinInt.size(1); ++filterIdx) {
              const int xMinCurr = xMinIntAcsr[inPlaneIdx][filterIdx];
              const int xMaxCurr = xMaxIntAcsr[inPlaneIdx][filterIdx];
              ...
              for (int x = 0; x < h; ++x) {
                for (int y = 0; y < w; ++y) {
                  ...
                  const int tAdv =
                      x + xMinCurr - 1 < h ? max(0, min(t - 1, h)) : t;
                  const int bAdv =
                      x + xMaxCurr >= 0 ? max(0, min(b + 1, h)) : b;
                  const int lAdv =
                      y + yMinCurr - 1 < w ? max(0, min(l - 1, w)) : l;
                  const int rAdv =
                      y + yMaxCurr >= 0 ? max(0, min(r + 1, w)) : r;

                  scalar_t outValue;

                  outValue = gradOutputAcsr[b][r] - gradOutputAcsr[t][r] -
                             gradOutputAcsr[b][l] + gradOutputAcsr[t][l];

                  if (exact) {
                    // -- xMax border
                    outValue +=
                        (gradOutputAcsr[bAdv][r] - gradOutputAcsr[b][r] -
                         gradOutputAcsr[bAdv][l] + gradOutputAcsr[b][l]) *
                        xMaxCurrFrac;

                    // -- yMax border
                    outValue +=
                        (gradOutputAcsr[b][rAdv] - gradOutputAcsr[b][r] -
                         gradOutputAcsr[t][rAdv] + gradOutputAcsr[t][r]) *
                        yMaxCurrFrac;

                    // -- xMin border
                    outValue +=
                        (gradOutputAcsr[t][r] - gradOutputAcsr[tAdv][r] -
                         gradOutputAcsr[t][l] + gradOutputAcsr[tAdv][l]) *
                        xMinCurrFrac;

                    // -- yMin border
                    outValue +=
                        (gradOutputAcsr[b][l] - gradOutputAcsr[b][lAdv] -
                         gradOutputAcsr[t][l] + gradOutputAcsr[t][lAdv]) *
                        yMinCurrFrac;

                    // -- corner pixels
                    outValue +=
                        xMaxCurrFrac * yMaxCurrFrac *
                        ((x + xMaxCurr >= h or y + yMaxCurr >= w or
                          x + xMaxCurr < 0 or y + yMaxCurr < 0 or b == bAdv or
                          r == rAdv)
                             ...
                             (gradOutputAcsr[b + 1][r + 1] -
                              ...
                              gradOutputAcsr[b + 1][r] + gradOutputAcsr[b][r]));

                    outValue += xMinCurrFrac * yMaxCurrFrac *
                                ((x + xMinCurr > h or y + yMaxCurr >= w or
                                  x + xMinCurr <= 0 or y + yMaxCurr < 0 or
                                  t == tAdv or r == rAdv)
                                     ? static_cast<scalar_t>(0)
                                     :
                    ...
                    outValue += xMaxCurrFrac * yMinCurrFrac *
                                ((x + xMaxCurr >= h or y + yMinCurr > w or
                                  x + xMaxCurr < 0 or y + yMinCurr <= 0 or
                                  b == bAdv or l == lAdv)
                                     ? static_cast<scalar_t>(0)
                                     :
                    ...
                    outValue += xMinCurrFrac * yMinCurrFrac *
                                ((x + xMinCurr > h or y + yMinCurr > w or
                                  x + xMinCurr <= 0 or y + yMinCurr <= 0 or
                                  t == tAdv or l == lAdv)
                                     ? static_cast<scalar_t>(0)
                                     :
...
// explicitly instantiate
template void boxConvUpdateGradInput<true, true>(at::Tensor &, at::Tensor &,
                                                 at::Tensor &, at::Tensor &,
                                                 at::Tensor &, at::Tensor &,
                                                 at::Tensor &, at::Tensor &,
                                                 at::Tensor &, at::Tensor &,
...
template void boxConvUpdateGradInput<false, true>(at::Tensor &, at::Tensor &,
                                                  at::Tensor &, at::Tensor &,
                                                  at::Tensor &, at::Tensor &,
                                                  at::Tensor &, at::Tensor &,
                                                  at::Tensor &, at::Tensor &,
...
template void boxConvUpdateGradInput<true, false>(at::Tensor &, at::Tensor &,
                                                  at::Tensor &, at::Tensor &,
                                                  at::Tensor &, at::Tensor &,
                                                  at::Tensor &, at::Tensor &,
                                                  at::Tensor &, at::Tensor &,
...
template void boxConvUpdateGradInput<false, false>(at::Tensor &, at::Tensor &,
                                                   at::Tensor &, at::Tensor &,
                                                   at::Tensor &, at::Tensor &,
                                                   at::Tensor &, at::Tensor &,
                                                   at::Tensor &, at::Tensor &,
...
void boxConvAccGradParameters(
    ...
    at::Tensor &xMinInt, at::Tensor &xMaxInt, at::Tensor &yMinInt,
    at::Tensor &yMaxInt, at::Tensor &xMinFrac, at::Tensor &xMaxFrac,
    at::Tensor &yMinFrac, at::Tensor &yMaxFrac, at::Tensor &input_integrated,
    at::Tensor &tmpArray, Parameter parameter) {
  // was `const int`, but had to remove `const` to work around a bug in GCC 5
  int h = tmpArray.size(-2);
  int w = tmpArray.size(-1);

  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      tmpArray.scalar_type(), "cpu::boxConvAccGradParameters", ([&] {
        auto xMinIntAcsr = xMinInt.accessor<int, 2>();
        auto xMaxIntAcsr = xMaxInt.accessor<int, 2>();
        auto yMinIntAcsr = yMinInt.accessor<int, 2>();
        auto yMaxIntAcsr = yMaxInt.accessor<int, 2>();
              ...
              for (int x = 1; x <= h; ++x) {
                for (int y = 1; y <= w; ++y) {
                  if (parameter == Parameter::xMin) {
                    ...
                    delta += inputIntAcsr[max(0, min(x + xMinInt, h))]
                                         [max(0, min(y + yMaxInt, w))];
                    delta -= inputIntAcsr[max(0, min(x + xMinInt - 1, h))]
                                         [max(0, min(y + yMaxInt, w))];
                    delta -= inputIntAcsr[max(0, min(x + xMinInt, h))]
                    ...
                    *(tmpArrayData++) = -delta;
                    ...
                    delta += inputIntAcsr[max(0, min(x + xMaxInt + 1, h))]
                                         [max(0, min(y + yMaxInt, w))];
                    delta -= inputIntAcsr[max(0, min(x + xMaxInt, h))]
                                         [max(0, min(y + yMaxInt, w))];
                    delta -= inputIntAcsr[max(0, min(x + xMaxInt + 1, h))]
                                         [max(0, min(y + yMinInt, w))];
                    delta += inputIntAcsr[max(0, min(x + xMaxInt, h))]
                    ...
                    *(tmpArrayData++) = delta;
                    ...
                    if (exact) {
                      ...
                      valid = not(y + yMinInt < 1) & not(x + xMaxInt < 0) &
                              not(x + xMaxInt >= h);
                      cornerX = max(0, min(h - 1, x + xMaxInt));
                      cornerY = max(0, min(w - 1, y + yMinInt - 1));
                      const scalar_t blCorner =
                    ...
                    *(tmpArrayData++) = -delta;
                    ...
                    if (exact) {
                      ...
                      valid = not(y + yMaxInt >= w) & not(x + xMaxInt < 0) &
                              not(x + xMaxInt >= h);
                      cornerX = max(0, min(h - 1, x + xMaxInt));
                      cornerY = max(0, min(w - 1, y + yMaxInt));
                      const scalar_t brCorner =
...
// explicitly instantiate
template void boxConvAccGradParameters<true>(at::Tensor &, at::Tensor &,
                                             at::Tensor &, at::Tensor &,
                                             at::Tensor &, at::Tensor &,
                                             at::Tensor &, at::Tensor &,
                                             at::Tensor &, at::Tensor &,
...
template void boxConvAccGradParameters<false>(at::Tensor &, at::Tensor &,
                                              at::Tensor &, at::Tensor &,
                                              at::Tensor &, at::Tensor &,
                                              at::Tensor &, at::Tensor &,
                                              at::Tensor &, at::Tensor &,
...
void clipParameters(at::Tensor &paramMin, at::Tensor &paramMax,
                    const double reparametrization, const double minSize,
                    const double maxSize) {
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      paramMin.scalar_type(), "cpu::clipParameters", ([&] {
...
at::Tensor computeArea(at::Tensor x_min, at::Tensor x_max, at::Tensor y_min,
                       at::Tensor y_max, const bool exact,
                       const bool needXDeriv, const bool needYDeriv) {
  // TODO: how to stop tracking operations??? `.is_variable_(false)` doesn't
  // work

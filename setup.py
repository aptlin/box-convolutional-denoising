...
def parallelCCompile(
    ...
    ThreadPool(n_processes).map(_single_compile, objects)
...
source_files_cuda_stubs = ["cuda_stubs.cpp"]
source_files = source_files_cpp + (
    source_files_cuda if build_cuda else source_files_cuda_stubs
)
